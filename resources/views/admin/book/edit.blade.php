<x-user-input-layout>
    ...
    <form method="POST" action="{{ route('books.update', $book->id) }}" novalidate class="space-y-4 md:space-y-6">
        @csrf
        @method('PUT')
        ...
        <div>
            ...
            <div>
                ...
                <input value="{{ $book->year }}" type="text" name="year" id="year"
                    class="border sm:text-sm rounded-lg block w-full p-2.5 bg-gray-700 border-gray-600 placeholder-gray-500 text-white"
            ...
            <div class="mb-3">
                ...
                <div class="flex">
                    ...
                    <a href="{{ route('authors.create', ['fromEditBook' => $book->id]) }}"
